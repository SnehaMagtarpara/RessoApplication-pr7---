...
class AgePage: UIViewController,UIPickerViewDelegate,UIPickerViewDataSource{
    ...
    @IBAction func nextButtonAction(_ sender: Any) {
        let n = storyboard?.instantiateViewController(withIdentifier: "MusicOption") as! MusicOption
